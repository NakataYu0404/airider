...
int Utility::ModuloTen(int i)
{

    return i % 10;
}

int Utility::ModuloHundled(int i)
{
    return i % 100;
}
...
{
    return rad * (Utility::ROT_HALF_DEG / DX_PI_F);
}

int Utility::Rad2DegI(int rad)
{
    return rad * Round(Utility::ROT_HALF_DEG / DX_PI_F);
}
...
{
    return deg * (DX_PI_F / Utility::ROT_HALF_DEG);
}

int Utility::Deg2RadI(int deg)
{
    return deg * Round(DX_PI_F / Utility::ROT_HALF_DEG);
}
...
VECTOR Utility::DistanceV(const VECTOR& v1, const VECTOR& v2)
{
    VECTOR ret;
    ret.x = v2.x - v1.x;
    ret.y = v2.y - v1.y;
